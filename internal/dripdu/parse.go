...
// flowPattern is the only accepted on-the-wire decimal form for flow_lph:
// an integer part plus at most three fractional digits. Exponents, signs and
// scientific notation are intentionally rejected so "three decimal places"
